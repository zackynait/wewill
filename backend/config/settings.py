...
SECRET_KEY = env('DJANGO_SECRET_KEY', default=str(uuid4()))
...
DATABASES = {
    'default': {
        ...
        'NAME': env('POSTGRES_DB', default='wewill'),
        'USER': env('POSTGRES_USER', default='wewill_user'),
        'PASSWORD': env('POSTGRES_PASSWORD', default='change_this'),
